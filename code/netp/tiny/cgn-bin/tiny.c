 ...
 * @version: v0.1
 * @Author: Elon C
 * @Date: 2021-01-31 21:42:39
 * @LastEditors: Elon C
 * @LastEditTime: 2021-02-01 00:06:57
 * @FilePath: \CSAPP\code\netp\tiny\cgn-bin\tiny.c
 */
...
void serve_static(int fd, char *filename, int filesize)
{
    ...
    sprintg(buf, "%sContent-length: %d\r\n", buf, filesize);
    sprintg(buf, "%sContent-type: %d\r\n", buf, filetype);
    Rio_writen(fd, buf, strlen(buf));
